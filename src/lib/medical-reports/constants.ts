...
export const MEDICAL_REPORT_SECTIONS: MedicalReportSectionDefinition[] = [
  ...
  },
  {
    ...
    subtitle: 'Body fluid analysis reporting',
    description: 'Body fluid worksheets and diagnostic reports with audit-ready workflow support.',
    emptyTitle: 'No body fluid reports yet',
    emptyDescription: 'Body fluid report fields and controlled templates will be added when the official layout is provided.',
    newActionLabel: 'New Body Fluid Report',
    historyActionLabel: 'History',
    showSearch: true,
  },
  {
