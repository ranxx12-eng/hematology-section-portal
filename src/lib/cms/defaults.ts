  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        item('nav-comparison-studies', '/quality/comparison-studies', 'comparisonStudies', 'GitCompare', 5, 'comparison.view'),
        item('nav-cv-monitoring', '/quality/cv-monitoring', 'cvMonitoring', 'LineChart', 6, 'cv_monitoring.view'),
        item('nav-qc-qr', '/quality-control/qr-codes', 'qcQrCodes', 'QrCode', 7, 'qc.manage'),
        item('nav-environmental', '/environmental-monitoring', 'environmentalMonitoring', 'Thermometer', 8, 'environmental.view'),
        item('nav-risk', '/risk-capa', 'riskCapa', 'Shield', 9, 'risk.view'),
      ],
    },
    {
