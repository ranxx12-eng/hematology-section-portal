  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        item('nav-environmental', '/environmental-monitoring', 'environmentalMonitoring', 'Thermometer', 9, 'environmental.view'),
        item('nav-risk', '/risk-capa', 'riskCapa', 'Shield', 10, 'risk.view'),
      ],
    },
    {
